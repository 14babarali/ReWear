...
import TSidebar from '../../components/Tailor/TSidebar.js';
import tailor_logo from '../../assests/rewear-logo.png';
      ...
      <nav className="navbar">
        <div className="navbar-content">
          <div className="navbar-left">
            ...
            <Link to={'/tailor'}>
            <img src={`${tailor_logo}`} alt="Profile" className="profile-image" />
            </Link>
            <h4>Tailor's View</h4>
